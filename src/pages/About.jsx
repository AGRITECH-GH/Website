...
function About() {
  return (
    <>
      ...
      <section className="section split-feature"><div className="feature-photo"><img src="https://images.unsplash.com/photo-1605000797499-95a51c5269ae?auto=format&fit=crop&w=900&q=80" alt="Farmer in greenhouse" /></div><div><span className="eyebrow">Our Story</span><h2>Empowering African farmers through precision.</h2><p>Founded with a clear field problem in mind, AgriTech Ghana supports farmers and agribusinesses with practical tools for better production, stronger records, trusted trade, and resilient growth.</p><p>We design around the realities of farmer communities, buyer needs, and partner reporting requirements.</p></div></section>
