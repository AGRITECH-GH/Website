...
function Training() {
  useSEO({
    title: "Training — AgriTech Ghana",
    description: "Agricultural training programmes and resources for farmers and agribusiness professionals."
  });
  ...
  return (
    <>
      <section className="page-hero light-hero page-offset training-hero">
        ...
        <div className="hero-image-card"><img src="https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?auto=format&fit=crop&w=900&q=80" alt="Training workshop" fetchpriority="high" /></div>
      </section>
