...
const categories = [
  ...
  { icon: "people", label: "Farmer Stories", desc: "Success stories from the AgriConnect network." },
];
  ...
  return (
    <>
      <section className="page-hero image-hero page-offset">
        ...
        <div className="page-hero-copy floating-copy"><span className="badge">Insights</span><h1>The rise of <span>regenerative technology</span></h1><p>Ideas, field lessons, and agribusiness perspectives from the AgriConnect ecosystem.</p></div>
      </section>
