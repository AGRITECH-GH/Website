...
function News() {
  useSEO({
    title: "News & Insights — AgriTech Ghana",
    description: "Latest news, reports and insights from Ghana's agricultural technology sector."
  });
  ...
  return (
    <>
      <section className="page-hero image-hero page-offset">
        <img src="https://images.unsplash.com/photo-1625246333195-78d9c38ad449?auto=format&fit=crop&w=1800&q=80" alt="Agricultural field" fetchpriority="high" />
